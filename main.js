...
let members = [`nimra`, `asma`, `rabia`, `nazia`];
...
let transportation = [`car`, `auto`, `bike`, `van`];
...
let guestlist1 = [`Asma`, `Nimra`, `Nazia`];
...
let guestList = [`Asma`, `Nimra`, `Nazia`];
let absentGuest = `Asma`;
let newGuest = `Laiba`;
...
let guest_List = [`Asma`, `Nimra`, `Nazia`];
let absent_Guest = `Asma`;
let new_Guest = `Laiba`;
...
let guest_list = [`Asma`, `Nimra`, `Bisma`, `Alina`];
//for (let i = 0; i <guest_list.length; i++) {
...
let places = [`lahore`, `islamabad`, `karachi`, `hydrabad`, `faisal abad`];
...
let languages = [`urdu`, `english`, `chiness`, `french`];
...
const user1_name = [`admin`, `ali`, `ahmed`, `usama`, `fahad`];
...
let user_name = [`admin`, `ali`, `ahmed`, `usama`, `fahad`];
...
let current_user = [`AlI`, `AhMed`, `saLman`, `sAleem`, `sAjid`];
let new_user = [`bilal`, `AhMed`, `sajaad`, `kAleem`, `sAjid`];
//for each methd
...
function describe_city_shirt(city, country = `Default country.`) {
...
let magician1 = [`Harry potter`, `Hermione Granger`, `Ron Weasley`, `Albus Dumbledore`];
